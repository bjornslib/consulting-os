...
Consulting OS is a 21-skill operating system for a strategy consulting
engagement inside Claude Code. It covers the full engagement. Frame the
problem, build a shared fact base, analyze the market and the competition,
and decide what to do. Then design how to deliver it, protect the plan
against risk, and carry the result to a decision-maker. A meta-skill, `consulting-os`,
sequences the other 20 for the engagement at hand and turns finished work
into reusable IP.

The skills form a kit, not a syllabus. Use the meta-skill to pick and
sequence the right subset for an engagement type: growth strategy,
pricing, transformation, portfolio review, or a rapid diagnostic. Or invoke
an individual skill directly when you already know what you need.
...
**Frame**
1. `consulting-os-problem-framing` — Frame a client problem precisely and decompose it into a MECE issue tree before any analysis starts.
...
3. `consulting-os-assumption-audits` — Surface, stress-test, and monitor the assumptions under a strategy, model, plan, or recommendation.
...
6. `consulting-os-customer-segmentation` — Segment a customer base or market into groups that behave differently, so you can serve and reach them differently.
7. `consulting-os-profit-pool-analysis` — Map where profit actually sits across a value chain, industry, or customer base, and where it moves.

**Decide**
8. `consulting-os-strategic-options` — Generate genuinely distinct strategic options and score them against explicit criteria to reach a recommendation.
...
**Design**
12. `consulting-os-operating-model-design` — Design or redesign how an organization delivers its strategy: structure, process, governance, capability, technology, and ways of working.
13. `consulting-os-initiative-prioritisation` — Prioritize a set of initiatives, projects, or use cases against value, feasibility, and capacity. Produce a sequenced, funded list and an explicit not-doing list.
14. `consulting-os-transformation-roadmaps` — Turn prioritized initiatives into an executable transformation roadmap: waves, milestones, dependencies, owners, funding gates, and change management.
...
16. `consulting-os-war-gaming` — Run a competitive war game. Simulate how competitors, regulators, and other players respond to a strategic move over multiple rounds, and harden the strategy against those responses.
...
19. `consulting-os-executive-narrative` — Turn analysis into a persuasive executive narrative and deck: a pyramid-principle storyline, action titles, evidence-backed pages.
20. `consulting-os-board-memos` — Write decision-grade board memos and papers: a clear ask, the case for and against, the risks, and a specific decision to record.

**Meta**
21. `consulting-os` — Orchestrate the full 21-skill suite. Select and sequence the right skills for an engagement, and run engagement hygiene: single-sourced artifacts, the assumption-audit gate, continuous stakeholder alignment. Harvest completed engagements into reusable frameworks, benchmarks, prompts, and lessons.
...
skills are available in every project through the `Skill` tool.

## Usage

Start any engagement with the meta-skill to get a sequencing
recommendation:
...
Or invoke an individual method directly once you know what you need, for
example:
...
We built and used these 21 skills inside `bjornslib/cobuilder-harness`.
This repository extracts them verbatim as a standalone, installable
plugin.
